...
-- Generated from EDMX file: C:\Users\no4804\source\repos\ImpactaAspNet_02\ApsNetVS2017.Capitulo08.EF.ModelFirst\LojaModel.edmx
-- --------------------------------------------------
...
-- Creating table 'ProdutoFornecedor'
...
-- Creating primary key on [Produto_Id], [Fornecedor_Id] in table 'ProdutoFornecedor'
ALTER TABLE [dbo].[ProdutoFornecedor]
ADD CONSTRAINT [PK_ProdutoFornecedor]
    PRIMARY KEY CLUSTERED ([Produto_Id], [Fornecedor_Id] ASC);
GO
...
-- Creating foreign key on [Produto_Id] in table 'ProdutoFornecedor'
ALTER TABLE [dbo].[ProdutoFornecedor]
...
-- Creating foreign key on [Fornecedor_Id] in table 'ProdutoFornecedor'
ALTER TABLE [dbo].[ProdutoFornecedor]
...
-- Creating non-clustered index for FOREIGN KEY 'FK_ProdutoFornecedor_Fornecedor'
CREATE INDEX [IX_FK_ProdutoFornecedor_Fornecedor]
ON [dbo].[ProdutoFornecedor]
    ([Fornecedor_Id]);
GO
